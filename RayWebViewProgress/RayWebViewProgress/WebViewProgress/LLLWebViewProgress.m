...
NSString *completeRPCURLPath = @"/lllwebviewprogressproxy/complete";

const float LLLInitialProgressValue = 0.1f;
const float LLLInteractiveProgressValue = 0.5f;
const float LLLFinalProgressValue = 0.9f;

@implementation LLLWebViewProgress
{
...
- (void)startProgress
{
    if (_progress < LLLInitialProgressValue) {
        [self setProgress:LLLInitialProgressValue];
    }
}
...
- (void)loadingProgress
{
    ...
    float maxProgress = _interactive ? LLLFinalProgressValue : LLLInteractiveProgressValue;
